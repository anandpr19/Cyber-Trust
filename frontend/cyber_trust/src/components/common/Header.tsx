        ...
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 group">
            <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center group-hover:from-blue-400 group-hover:to-blue-500 transition-all duration-300">
              <span className="text-white font-bold text-lg" style={{ color: 'white' }}>🔒</span>
            </div>
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <button
              onClick={toggleTheme}
              className="relative w-14 h-7 rounded-full bg-slate-700 hover:bg-slate-600 transition-all duration-300 flex items-center px-1"
